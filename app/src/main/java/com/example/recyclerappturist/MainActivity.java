package com.example.recyclerappturist;
...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] Categorias =
                new String[]{"Categorias", "Hoteles", "Restaurantes", "Lugares Turisticos"};
        //paso 2 adaptador
        ...
        final String[] subCategorias =
                new String[]{"Categorias2", "Hoteles", "Restaurantes", "Lugares Turisticos"};
        //paso 2 adaptador
